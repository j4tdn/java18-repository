...
public class OutPut {
	...
	public static void Spacecar(UsingCar usingCar) {
	...
	public static void Spacecc(UsingCar usingCar) {
	...
	public static void Spacevalue(UsingCar usingCar) {
