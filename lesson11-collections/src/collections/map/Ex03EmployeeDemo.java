 ...
 * + Nếu đã có => ghi đè 
 * 
 * Duyệt từng entry (phần tử) trong Map
 * Kiểm tra nếu có entry.getKey nào mà trùng với m1.getKey => m1 đã tồn tại
 * 
 * "trùng" có nghĩa là tồn tại 1 key mà 
 *  + equals với m1.getKey 
 *  + key có hashcode trùng với m1 hashcode (mặc định là địa chỉ)
 * --> qua Map, Set --> override hashcode --> dãy số được hashing ra từ giá tị của map entry
 *  
...
public class Ex03EmployeeDemo {
	public static void main(String[] args) {
		Map<Employee, List<Employee>> offices = mockData();
