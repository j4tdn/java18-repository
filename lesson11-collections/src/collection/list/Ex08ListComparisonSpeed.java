...
public class Ex08ListComparisonSpeed {
	...
	public static void main(String[] args) {
		...
		System.out.println("Add to the end " + COUNT + " elements: ArrayList took " + (System.currentTimeMillis() - start) + "ms");

		start = System.currentTimeMillis();
		for (int i = 0; i < COUNT; i++) {
			llist.add("element # " + i);
		}
		System.out.println("Add to the end " + COUNT + " elements: LikedList took " + (System.currentTimeMillis() - start) + "ms");
