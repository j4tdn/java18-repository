...
public class Ex01StringImmutable_Literal_ObjectDemo {
	public static void main(String[] args) {
		// immutable object(bất biến - ko thể thay đổi giá trị(ở heap) của đối tượng
		// giá trị của biến string literal sẽ được lưu trở ở
		// HEAP -> constant pool
		
		// string literal tiết kiệm vùng nhớ tạo ra ở HEAP --> String, Integer, Double...
		
		// immutable --> đảm bảo giá trị của immutable object ko thể thay đổi khi truyền qua
		// method, class để xử lý
		String s1 = "welcome";
		String s2 = "welcome";
		String s3 = "welcome";
		String s4 = "welcome";
