...
public class Ex01StringImmutable_Literal_ObjectDemo {
	public static void main(String[] args) {
		...
		// immutable (bất biến - ko thể thay đối giá trị của biến)
		// immutable --> đảm bảo giá trị của immubtale object ko thể thay đổi khi
		// truyền qua method, class để xử lý
		// giá trị của biến String literal sẽ được
		// ==> lưu trữ ở HEAP --> constant pool

		// string literal --> tiết kiệm vùng nhờ tạo ra ở HEAP --> String, Integer,
		// Double ...
		...
		// stirng object: giá trị của đối tượng thuốc string object
