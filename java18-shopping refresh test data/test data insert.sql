...
VALUES	(1, 'Susan', str_to_date('14.10.1975', '%d.%m.%Y'), 'Đà Nẵng', 123456789, 0, 'susan@gmail.com', '1234'),
		(2, 'Smith', str_to_date('12.07.1975', '%d.%m.%Y'), 'Quảng Nam', 123456789, 0, 'smith@gmail.com', '1234'),
        (3, 'Henry', str_to_date('18.09.1976', '%d.%m.%Y'), 'Đà Nẵng', 123456789, 0, 'henry@gmail.com', '1234'),
        (4, 'Pepe', str_to_date('24.10.1985', '%d.%m.%Y'), 'Đà Nẵng', 123456789, 0, 'pepe@gmail.com', '1234'),
        (5, 'Carlos', str_to_date('14.02.1978', '%d.%m.%Y'), 'Đà Nẵng', 123456789, 0, 'carlos@gmail.com', '1234');
...
VALUES	(1, 'Địa chỉ 1', 0, str_to_date('10.10.2023', '%d.%m.%Y'), 20, current_timestamp(), 1, 1),
        ...
        (4, 'Địa chỉ 4', 0, str_to_date('15.10.2023', '%d.%m.%Y'), 20, current_timestamp(), 4, 2),
        (5, 'Địa chỉ 5', 0, str_to_date('10.10.2023', '%d.%m.%Y'), 30, current_timestamp(), 2, 3),
        (6, 'Địa chỉ 6', 0, str_to_date('14.10.2023', '%d.%m.%Y'), 20, current_timestamp(), 5, 1),
        (7, 'Địa chỉ 7', 0, str_to_date('19.10.2023', '%d.%m.%Y'), 40, current_timestamp(), 1, 2),
        (8, 'Địa chỉ 8', 0, str_to_date('18.10.2023', '%d.%m.%Y'), 20, current_timestamp(), 2, 3),
        (9, 'Địa chỉ 9', 0, str_to_date('16.10.2023', '%d.%m.%Y'), 50, current_timestamp(), 3, 3),
        (10, 'Địa chỉ 10', 0, str_to_date('10.10.2023', '%d.%m.%Y'), 20, current_timestamp(), 5, 2),
        (11, 'Địa chỉ 11', 0, str_to_date('12.10.2023', '%d.%m.%Y'), 10, current_timestamp(), 4, 2),
        (12, 'Địa chỉ 12', 0, str_to_date('10.10.2023', '%d.%m.%Y'), 20, current_timestamp(), 3, 1);
...
VALUES	(1, 'Nhân viên A', str_to_date('14.02.2001', '%d.%m.%Y'), 'Đà Nẵng', 123456789, 0, 'nhanviena@gmail.com', '12345678',1),
		(2, 'Nhân viên B', str_to_date('14.02.2001', '%d.%m.%Y'), 'Đà Nẵng', 123456789, 1, 'nhanvienb@gmail.com', '12345678',1),
        (3, 'Nhân viên C', str_to_date('14.02.2001', '%d.%m.%Y'), 'Đà Nẵng', 123456789, 1, 'nhanvienc@gmail.com', '12345678',2),
        (4, 'Nhân viên D', str_to_date('14.02.2001', '%d.%m.%Y'), 'Đà Nẵng', 123456789, 0, 'nhanviend@gmail.com', '12345678',3),
        (5, 'Nhân viên E', str_to_date('14.02.2001', '%d.%m.%Y'), 'Đà Nẵng', 123456789, 0, 'nhanviene@gmail.com', '12345678',2),
        (6, 'Nhân viên F', str_to_date('14.02.2001', '%d.%m.%Y'), 'Đà Nẵng', 123456789, 1, 'nhanvienf@gmail.com', '12345678',2),
        (7, 'Nhân viên G', str_to_date('14.02.2001', '%d.%m.%Y'), 'Đà Nẵng', 123456789, 0, 'nhanvieng@gmail.com', '12345678',4),
        (8, 'Nhân viên X', str_to_date('14.02.2001', '%d.%m.%Y'), 'Đà Nẵng', 123456789, 0, 'nhanvienx@gmail.com', '12345678',5);
...
VALUES	(1, 'Áo 1', 'Trắng', 'Chất liệu 1', 'default.png', 'default.png', current_timestamp(), 1, 1),
        ...
        (12, 'Quần 1', 'Đen', 'Chất liệu 3', 'default.png', 'default.png', current_timestamp(), 2, 2),
        (13, 'Quần 2', 'Đen', 'Chất liệu 3', 'default.png', 'default.png', current_timestamp(), 2, 1),
        (14, 'Quần 3', 'Trắng', 'Chất liệu 1', 'default.png', 'default.png', current_timestamp(), 2, 1);

-- 5 --> giao hàng thành công
-- 3 --> đóng gói thành công
-- 2 --> đang giao hàng

INSERT INTO `order_delivery_status_detail`(ORDER_ID, STATUS_ID, EMPLOYEE_ID, LAST_UPDATED_AT)
VALUES	(11, 7, 1, current_timestamp()),	-- cancel
		(12, 7, 1, current_timestamp());	-- cancel
        
WITH CTE_DELIVERY_STATUS_DETAIL AS (

	-- 1.Đơn hàng từ 1 - 5 --> Giao hàng thành công (trạng thái 1 - 6)
	...
	-- 2. Đơn hàng từ 6 - 8 --> Đóng gói thành công(trạng thái 1 - 4)
	SELECT 	dorder.ID ORDER_ID,
			dstatus.ID STATUS_ID,
			2 EMPLOYEE_ID,
	...
	-- 3. Đơn hàng từ 9 - 10 --> Đang giao hàng (trạng thái 1 - 5)
	SELECT 	dorder.ID ORDER_ID,
			dstatus.ID STATUS_ID,
			3 EMPLOYEE_ID,
    ...
    -- 4. đơn hàng 11 - 12 --> hủy đơn hàng(trạng thái 7)
	SELECT 	dorder.ID ORDER_ID,
			7 STATUS_ID,
			4 EMPLOYEE_ID,
...
VALUES	(1, 1, 5), (1, 2, 2), (1, 5, 10), (1, 14, 1),
		(2, 3, 5), (2, 2, 2), (2, 5, 10), (2, 12, 1),
        (3, 2, 2), (3, 3, 2), (3, 5, 11), (3, 13, 1),
        (4, 4, 3), (4, 9, 2), (4, 5, 3), (4, 7, 3),
        (5, 5, 6), (5, 6, 2), (5, 2, 8), (5, 9, 3),
...
-- INSERT INTO `item_detail`(ITEM_ID, SIZE_ID, ADDRESS, BUY_PRICE, SELL_PRICE);
...
SELECT mod(item.ID, 2) FROM `item`;
-- CROSS JOIN
...
SELECT 	item.ID ITEM_ID,
		size.ID SIZE_ID,
		120 AMOUNT,
        300 - size.ID * 5 BUY_PRICE,
        300 + size.ID *10 SELL_PRICE
	FROM `item`, `size`
WHERE mod(item.ID, 2) = 1 AND mod(size.ID, 2) = 1
ORDER BY item.ID, size.ID;
-- enable all fks
