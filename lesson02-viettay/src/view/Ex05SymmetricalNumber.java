...
/**
 * 
 * Viết chương trình kiểu tra N có phải là số đối xứng hay không Biết rằng N
 * được nhập từ bàn phím là một số nguyên dương có tối thiểu 2 chữ số VD: Nhập N
 * = abc -> báo lỗi, yêu cầu nhập lại = a123 -> báo lỗi, yêu cầu nhập lại = 1 ->
 * báo lỗi, yêu cầu nhập lại = 256 -> false = 12525 -> true = 2662 -> true
 *
 */
