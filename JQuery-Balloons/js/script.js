    ...
    setInterval(() => {
        ...
        if (element) {
            ...
            if (move >= 100) {
                ...
                let btnRestartGame = document.querySelector('.restart');
                let btnCancelGame = document.querySelector('.cencel');
                btnRestartGame.onclick = function(){
                    location.reload();
                }
                btnCancelGame.onclick = function(){
                    loseElement.style.display='none';
                    totalShadowElement.style.display = 'none';
                }
            }
        }
    }, 30)
