...
ALTER TABLE item_detail DROP PRIMARYKEY;
ALTER TABLE item_detail ADD CONSTRAINT FK_ITEM_DETAIL_ITEM FOREIGN KEY(ITEM_ID) REFERENCES ITEM(id) ; 
ALTER TABLE item_detail ADD CONSTRAINT FK_ITEM_DETAIL_SIZE FOREIGN KEY(SIZE_ID) REFERENCES SIZE(id) ; 
-- step 2: create new column 'id' --> primary key
ALTER TABLE item_detail DROP COLUMN ID;
ALTER TABLE item_detail ADD COLUMN ID INT FIRST ;
...
DELIMITER $$
CREATE FUNCTION randInt( a INT, b INT )
RETURNS INT
BEGIN
