...
public class Ex03QuickSort_Item {
	public static void main(String[] args) {
		...
		// Item phải là con(implement) của Comparable và override hàm compareTo của
		// Comparable
		// Hạn chế ---> Việc sắp xếp phụ thuộc vào Item#compareTo
		// Item chỉ có duy nhất 1 hàm compareTo --> k thể hỗ trợ nhiều kiểu sort cùng
		// lúc
		// cho mảng items
	...
	private static Item[] getItems() {
		return new Item[] { new Item(1, "Item A1", 252, LocalDate.of(2023, 10, 10)),
