...
public class Ex01ArrayObjectType {
	public static void main(String[] args) {
		// Mảng là KDL đối tượng --> giá trị sẽ đc lưu trữ ở HEAD
		// Mỗi phần tử có thể là KDL nguyên thủy int[]
		//						 KDL đối tượng Item[]
		int[] numbers = {1, 2, 3, 4};
		System.out.println("numbers tuype: " + numbers.getClass());
		modify(numbers);
	...
	private static void swap(int[] elements, int i, int swap) {
		int tmp = elements[i];
