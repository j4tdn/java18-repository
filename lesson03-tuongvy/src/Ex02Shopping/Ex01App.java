...
public class Ex01App {
	public static void main(String[] args) {
		...
		Order order1 = new Order(customer1, new ItemDetail[]{
				...
				new ItemDetail(item2, 2)}, LocalDate.of(2022, 7, 5));
		Order order2 = new Order(customer2, new ItemDetail[]{
				new ItemDetail(item3, 3),
				new ItemDetail(item2, 2)}, LocalDate.of(2022, 5, 5));
		Order order3 = new Order(customer3, new ItemDetail[]{
				new ItemDetail(item4, 3),
				new ItemDetail(item3, 2)}, LocalDate.of(2022, 11, 4));
