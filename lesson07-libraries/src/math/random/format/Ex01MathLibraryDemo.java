 ...
 * 
 * Math.round() --> not support set scale --> round to long (kind of Integer)
 * 
 * In reality --> calculation, rounding for decimal number
 * 			  --> BigDecimal: class contains double, float value & support add/subtract/multiple/divide
 *                            & rounding with scale
 */
...
public class Ex01MathLibraryDemo {
	public static void main(String[] args) {
		...
		long roundedDnumber = Math.round(dnumber); // not support set scale --> round to long 
