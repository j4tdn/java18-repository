...
public class Ex03Java07 {
	public static void main(String[] args) {
		...
		System.out.println("2. The last date of current month: " + getLastDay(c));
		getFirstAndLastDayOfWeek(c);
		System.out.println("4. It is week number " + c.get(Calendar.WEEK_OF_YEAR) + " of the year.");
		addDay(c);
		timeLived(c);
	}

	private static void timeLived(Calendar date) {
		Calendar dayOfBirth = Calendar.getInstance();
		dayOfBirth.set(2002, 05, 11);
	...
	private static void getFirstAndLastDayOfWeek(Calendar date) {
	...
	private static String getLastDay(Calendar c) {
