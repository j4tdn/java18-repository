...
public class App {
	public static void main(String[] args) {
		...
		Item i5 = new Item("WP8","WindownPhone","Blu",560);
		...
		System.out.println("order 1 : " + OrderFunsion.export(o1));
		System.out.println("order 2 : " + OrderFunsion.export(o2));
		System.out.println("order 3 : " + OrderFunsion.export(o3));
	}
}
