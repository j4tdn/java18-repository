...
public class App {
	public static void main(String[] args) {
		Customer c1 = new Customer("KH1","Adam","123","NY");
		Customer c2 = new Customer("KH2","Kate","234","Cali");
		
		Item i1 = new Item("SS10+","Android","Black", 620.0);
		Item i2 = new Item("SS20U","Android","Green", 840.0);
		Item i3 = new Item("IP4","IOS","White", 280.0);
		Item i4 = new Item("IP12","IOS","Black", 880.0);
		Item i5 = new Item("WP8","WindowPhone","Blue", 560.0);
		...
		Order o3 = new Order(c2, new ItemDetail[] {
         ...
         System.out.println("o1:"+ o1.export());
         System.out.println("o2:"+ o2.export());
         System.out.println("o3:"+ o3.export());
	}
