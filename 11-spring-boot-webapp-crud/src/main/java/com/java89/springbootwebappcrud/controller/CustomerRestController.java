package com.java89.springbootwebappcrud.controller;

import com.java89.springbootwebappcrud.entity.Customer;
import com.java89.springbootwebappcrud.exception.EntityNotFoundException;
import com.java89.springbootwebappcrud.pagination.Pageable;
import com.java89.springbootwebappcrud.service.CustomerService;
...
public class CustomerRestController {
    ...
    @GetMapping("/customers/spec/{customerId}")
    public List<Customer> testJpa2Specs(@PathVariable Long customerId) {
        return customerService.getDataWithSpecs(customerId);
    }
...
//				totalPages
        ...
        return new Pageable<>(customerService.getAll(), totalPages);
    }
