...
public class HibernateTests {
	...
	public static void main(String[] args) {
		...
		// Tạo session(thread, luồng thực thi truy cập đến dtbase) từ session factory
		...
		// Cách 2: currentSession --> khởi tạo ban đầu(cấu hình thêm chỗ hibernate configuration) khi
		// tạo session factory, gọi getCurrentSession luôn trả về 1 đối tượng session duy nhất 
