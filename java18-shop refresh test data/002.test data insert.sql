...
INSERT INTO `DEPARTMENT` 
  ...
  (11,'XXXL',0,"Mô tả : XXXL Nữ chi tiết ..."),
  (12,'XXXL',1,"Mô tả : XXXl Nam chi tiết ...");
...
INSERT INTO `order`(ID, DELIVERY_ADDRESS, TOTAL_FEE, DELIVERY_DATE, DELIVERY_FEE, CREATE_AT, CUSTOMER_ID, PAYMENT_METHOD_ID)
...
INSERT INTO `bill`(ID, CREATE_AT, ORDER_ID)
...
INSERT INTO `item`(ID, `NAME`, COLOR, MATERIAL, IMAGE_01, IMAGE_02, LAST_UPDATE_AT, ITEM_GROUP_ID, PROVIDER_ID)
...
INSERT INTO `order_delivery_status_detail`(ORDER_ID, STATUS_ID, EMPLOYEE_ID, LAST_UPDATE_AT)
