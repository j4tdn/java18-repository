...
public class Ex03EmployeeDemo {
	public static void main(String[] args) {
		...
		//How map check duplicate key
		Employee m1 = new Employee(1, "m1", 1000d, null);
		Employee e41 = new Employee(41, "e41", 1000d, m1.getId());
		Employee e42 = new Employee(42, "e42", 1000d, m1.getId());
		
		office.put(m1, List.of(e41,e42));
		
		System.out.println("Office size -->" + office.size());
		
		//Thông thường 1 đối tượng --> hashcode(object) --> là địa chỉ mà jvm cấp phát cho vùng 
		//--> System.identityHashcode
		
		
		//Kiểm tra xem m1 đã tồn tại trong map hay chưa
		
		//Duyệt từng phần tử (entry) trong map. Kiểm tra nếu có
		//Nếu có entry.getKey nào mà 'Trùng' với m1.getKey --> m1 đã tồn tại
		
		//'trùng' --> tồn tại 1 key mà equals với m1 key
		//				và 		key có hashcode trùng với m1 hashcode (mặc định là địa chỉ)
		
		// --> qua map, set --> overrided hashcode --> dãy số được hashing ra từ giá trị của map entry
	...
	private static Map<Employee, List<Employee>> mockData() {
		...
		Employee m3 = new Employee(3, "m3", 5000d, m2.getId());
		
		Employee e11 = new Employee(11, "E11", 490d, m1.getId());
		Employee e12 = new Employee(12, "E12", 400d, m1.getId());
		Employee e13 = new Employee(13, "E13", 400d, m1.getId());
		
		Employee e21 = new Employee(21, "E21", 490d, m2.getId());
		Employee e22 = new Employee(22, "E22", 400d, m2.getId());
		
		Employee e31 = new Employee(31, "E31", 490d, m3.getId());
